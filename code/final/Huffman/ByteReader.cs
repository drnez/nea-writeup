class ByteReader
{
    ...
    public int Read()
    {
        ...
        if (_bytes.Count() == 1 && _bitIndex >= 8 - _trailingNum) return -1; // don't read padding zeros
    ...
    public char? ReadChar()
    {
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            if (bit == 1) nextByte |= (byte)(1 << (7-i)); // shift 1 to its position and OR with exisiting 00...0 byte
        }
