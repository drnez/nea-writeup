...
The second point mentioned was allowing the user to store multiple versions of a file as backups. [have a record file storing like a dictionary or smth linking files to versions held, or some filename magic]
