...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item It should be very unlikely for the client to use more than 5\% of CPU time while running on a modern laptop; my client's processor, the Intel i9-12950HX, can be used for a test case,
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \item It should be very unlikely for the server program to at any point use more than 200MB of RAM,
        \item It should be very unlikely for the server program to use more than 10\% of CPU time while running on such a device; my client's desired server's processor, a 2\textsuperscript{nd} generation Intel i5 processor, can be used as a test case, 
    \end{enumerate}
